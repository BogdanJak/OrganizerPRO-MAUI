namespace OrganizerPRO.Infrastructure.Persistence.Interceptors;
...
public class AuditableEntityInterceptor : SaveChangesInterceptor
{
    ...
    private static void SetCreationAuditInfo(IAuditableEntity entity, string userId, string tenantId, DateTime now)
    {
        ...
        if (entity is IMustHaveTenant mustTenant && mustTenant.TenantId == null) mustTenant.TenantId = Guid.Parse(tenantId);
        if (entity is IMayHaveTenant mayTenant && mayTenant.TenantId == null) mayTenant.TenantId = Guid.Parse(tenantId);
    }
